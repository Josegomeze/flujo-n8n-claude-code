// Construye el v83 a partir del v76 (= v82 + meses de hueco hasta el primer pago
// + notaría como residual de reconciliación en cotización por letra [en model.js]): todo lo del v78 (motor por código, hoja
...
const OUT = '/home/user/flujo-n8n-claude-code/Cotizador_Fiflouu__web__v83.html';
...
console.log(`v83 generado. Tamaño: ${(src.length / 1024).toFixed(0)} KB`);
