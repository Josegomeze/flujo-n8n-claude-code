// Construye el v80 a partir del v76 (= v79 + CSS máx 48 meses en G15/AK3): todo lo del v78 (motor por código, hoja
...
const OUT = '/home/user/flujo-n8n-claude-code/Cotizador_Fiflouu__web__v80.html';
...
// 2) RAW: quitar fórmulas + RE-MAPEAR MATRICES + ajustes del web
{
  ...
  console.log('ajustes: R22=132, R24=48, AK7=144, AK3=48');
...
console.log(`v80 generado. Tamaño: ${(src.length / 1024).toFixed(0)} KB`);
