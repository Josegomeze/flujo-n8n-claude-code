// Construye el v82 a partir del v76 (= v81 + meses de financiamiento CALENDARIO
// [incluye mes inicial parcial, en model.js] + Débito respeta el plazo solicitado): todo lo del v78 (motor por código, hoja
...
const OUT = '/home/user/flujo-n8n-claude-code/Cotizador_Fiflouu__web__v82.html';
...
console.log(`v82 generado. Tamaño: ${(src.length / 1024).toFixed(0)} KB`);
