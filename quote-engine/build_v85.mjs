// Construye el v85 a partir del v76: todo lo del v84 + matrices literales del
// portal (DD y Débito/Voluntario), tope de meses de comisión al promotor por
// clave×tipo y servicio Jubilado 3%. Débito usa las matrices variante (model.js).: todo lo del v78 (motor por código, hoja
...
const OUT = '/home/user/flujo-n8n-claude-code/Cotizador_Fiflouu__web__v85.html';
...
console.log(`v85 generado. Tamaño: ${(src.length / 1024).toFixed(0)} KB`);
