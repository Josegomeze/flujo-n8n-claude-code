// Construye el v86 a partir del v76: todo lo del v85 (matrices del portal,
// calibración 25/25) MÁS el switch por clave de la BASE de la comisión al
// promotor (AL2:AL7): 0 = % sobre el total a pagar (método original, gross-up)
// · 1 = % sobre el monto a financiar (la obligación neta, misma base de los
// intereses). El techo de meses aplica con ambas bases. La sección 5c del panel
// financiera se separa en un cuadro por clave (switch + fila de meses) y la
// tabla de referencia muestra la base por clave con el resaltado amarillo.
//
...
const OUT = '/home/user/flujo-n8n-claude-code/Cotizador_Fiflouu__web__v86.html';
...
`H+='<h3>5c · Comisión al promotor por clave<span class="src">base: Calculadora!AL2:AL7 · meses: AI10:AO15</span></h3>';
 ...
 for(let r=10;r<=15;r++){
   ...
   H+='<div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;margin-bottom:7px"><b style="min-width:130px">'+(_cl||('Fila '+r))+'</b>';
...
console.log(`v86 generado. Tamaño: ${(src.length / 1024).toFixed(0)} KB`);
