// Construye el v79 a partir del v76: todo lo del v78 (motor por código, hoja
...
const OUT = '/home/user/flujo-n8n-claude-code/Cotizador_Fiflouu__web__v79.html';
...
// 2) RAW: quitar fórmulas + RE-MAPEAR MATRICES + ajustes del web
{
  ...
  console.log('ajustes web: R22=132, R24=48, AK7=144');
...
console.log(`v79 generado. Tamaño: ${(src.length / 1024).toFixed(0)} KB`);
