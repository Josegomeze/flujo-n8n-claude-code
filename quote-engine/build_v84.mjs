// Construye el v84 a partir del v76 (= v83 + reconciliación de notaría también en
// modo por monto: recibido = monto exacto, total = letra × pagos [en model.js]): todo lo del v78 (motor por código, hoja
...
const OUT = '/home/user/flujo-n8n-claude-code/Cotizador_Fiflouu__web__v84.html';
...
console.log(`v84 generado. Tamaño: ${(src.length / 1024).toFixed(0)} KB`);
